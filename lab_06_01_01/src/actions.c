...
{
    printf("Лабораторная работа №6, ТиСД, Вариант 1. Обработка деревьев и хеш-таблиц\n");
    printf("\n");
    printf("Данная программа предоставляет возможность, использовав данные из файла (содержимое - слова),\n");
    printf("построить ДДП, сбалансировать его, построить хеш-таблицу (используя метод цепочек), осуществить\n");
    printf("поиск введённого слова в ДДП, сбалансированном дереве, в хэш-таблице и в файле, а также сравнить\n");
    printf("время поиска, объем  памяти  и  количество  сравнений  при использовании различных (4-х) структур\n");
    printf("данных, при этом если количество сравнений в хеш-таблице больше введённого, то производится\n");
